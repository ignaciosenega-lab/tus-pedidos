...
const MASTER_NAV_ITEMS = [
  ...
  { to: "/admin/operacion-global", label: "Operación global", icon: "M3 10h18M7 15h1m4 0h1m-7 4h12a3 3 0 003-3V8a3 3 0 00-3-3H6a3 3 0 00-3 3v8a3 3 0 003 3z" },
  { to: "/admin/alertas", label: "Alertas", icon: "M12 9v2m0 4h.01M5 19h14a2 2 0 001.84-2.75L13.74 4a2 2 0 00-3.48 0L3.16 16.25A2 2 0 005 19z" },
  ...
  { to: "/admin/versiones", label: "Versiones", icon: "M3 10h10a8 8 0 018 8v2M3 10l6 6m-6-6l6-6" },
...
const BRANCH_NAV_ITEMS = [
  ...
  { to: "/admin/ruleta", label: "Ruleta", icon: "M12 3a9 9 0 100 18 9 9 0 000-18zm0 0v9m0 0l6.36 6.36M12 12l-6.36 6.36" },
  ...
  { to: "/admin/barrios", label: "Barrios cerrados", icon: "M3.75 21h16.5M4.5 3h15M5.25 3v18m13.5-18v18M9 6.75h1.5m-1.5 3h1.5m-1.5 3h1.5m3-6H15m-1.5 3H15m-1.5 3H15M9 21v-3.375c0-.621.504-1.125 1.125-1.125h3.75c.621 0 1.125.504 1.125 1.125V21" },
  ...
  { to: "/admin/estilos", label: "Diseño", masterOnly: true, icon: "M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485M7 17h.01" },
  ...
  { to: "/admin/ayuda", label: "Ayuda", icon: "M8.228 9c.549-1.165 2.03-2 3.772-2 2.21 0 4 1.343 4 3 0 1.4-1.278 2.575-3.006 2.907-.542.104-.994.54-.994 1.093m0 3h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" },
];
